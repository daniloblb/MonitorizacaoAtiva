...
/***********************************************************************************************************************************
--- MONITORIZAÇÃO ATIVA 
--- 3.3 - XEvent Error - Job and Alert
***********************************************************************************************************************************/
...
BEGIN
	...
	BEGIN
		...
		from sys.fn_xe_file_target_read_file
			('C:\DATA\what_queries_are_failing*.xel',
			'C:\DATA\what_queries_are_failing*.xem',
			null, null)
	...
	(set filename = 'C:\DATA\what_queries_are_failing.xel' ,
	metadatafile = 'C:\DATA\what_queries_are_failing.xem',
	max_file_size = 500,
