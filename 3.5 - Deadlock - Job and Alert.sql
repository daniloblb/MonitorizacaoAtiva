...
FROM master.sys.fn_xe_telemetry_blob_target_read_file('dl', null, null, null) A
	LEFT JOIN MonitorizacaoAtiva.dbo.Log_DeadLock AS B ON CAST(A.timestamp_utc AS DATETIME) = B.eventDate
...
BEGIN
	...
	ADD TARGET package0.asynchronous_file_target(
	  SET filename = 'C:\DATA\capture_deadlocks.xel',
		  max_file_size = 500,
