/***********************************************************************************************************************************
--- MONITORIZAÇÃO ATIVA 
--  3.4 - Index Fragmentation History
***********************************************************************************************************************************/
...
BEGIN
	...
	INSERT INTO MonitorizacaoAtiva.dbo.User_Table(Nm_Table)
	SELECT DISTINCT A.Nm_Table 
	FROM ##Index_Fragmentation_History A
		LEFT JOIN MonitorizacaoAtiva.dbo.User_Table B ON A.Nm_Table = B.Nm_Table
